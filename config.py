...
class Config(object):
    ...
    DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://asvm:incorrectasvm@cluster0.v2z8vnw.mongodb.net/?appName=Cluster0")
    ...
    BIN_CHANNEL = int(os.environ.get("BIN_CHANNEL", "-1003047918112"))     
